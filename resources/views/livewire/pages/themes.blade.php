    ...
    <div class="bg-gray-50 border-b border-gray-100">
        <div class="max-w-6xl mx-auto px-6 py-8">
            <div class="max-w-4xl">
                ...
                <p class="text-sm text-gray-600 font-light">Join our community in exploring different topics each week.
                        ...
                        <div class="border border-gray-200 rounded-lg p-6 md:p-8 mb-8">
                            <div class="flex items-center gap-2 mb-4">
                                ...
                                @if ($theme->days_remaining > 0)
                                    <span class="text-gray-400">• {{ $theme->days_remaining }}
                        ...
                        @foreach ($upcomingThemes as $theme)
                            <div class="bg-gray-50 border border-gray-200 rounded-lg p-6">
                                <div class="flex items-center gap-2 mb-3">
                                    <span
                                        class="text-sm font-medium text-gray-500">{{ $theme->start_date->format('M j') }}
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @foreach ($pastThemes as $theme)
                            <div
                                ...
                                <div class="flex items-center gap-2 mb-3">
                                    <span class="text-xs text-gray-500">{{ $theme->start_date->format('M j') }} -
